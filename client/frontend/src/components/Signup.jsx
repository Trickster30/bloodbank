...
const Signup = () => {
  ...
  const handleSignup = () => {
    axios.post("http://127.0.0.1:3000/auth/signup", inputs)
      .then((res) => {
        console.log(res);
        alert(res.data.user.email + " is created");
        navigate('/login');
      })
      .catch((err) => {
